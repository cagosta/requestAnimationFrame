...
define( 'engineDetector/EngineDetector',[],function() {
...
define('engineDetector/engineDetector',[
    ...
    return new EngineDetector

} );
define( 'ifEngineIsNode',[
...
/**
 * requestAnimationFrame version: "0.0.10" Copyright (c) 2011-2012, Cyril Agosta ( cyril.agosta.dev@gmail.com) All Rights Reserved.
 * Available via the MIT license.
...
;
define("requestAnimationFrame/main", function(){});
}());